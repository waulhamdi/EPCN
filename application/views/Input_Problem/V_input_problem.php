                      ...
                      <div id="accordion">
                          ...
                          <div class="card card-primary">
                            ...
                            <div class="card-header">
                              ...
                              <h4 class="card-title">
                                <?php if ($this->session->userdata('DepartmentAdd')||$this->session->userdata('rolename')=='Administrator Quality'||$this->session->userdata('rolename')=='User Quality') { ?>
        ...
        <div class="modal-dialog modal-lg" role="document" >
            <div class="modal-content">            
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="name">NAME FROM</label>
                    </div>
                    <div class="col-md-8">
              ...
              <div class="row">
                  <div class="col-md-4">
                    <label for="section1">SECTION FROM</label>
                  </div>
                  <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-md-4">
                  <label for="email1">EMAIL FROM</label>
                </div>
                <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="input-group date" data-date-format="YYYY-MM-DD"  id="timepickercontainment_date" data-target-input="nearest" >
                        <input type="text" id="containment_date" name="containment_date" class="form-control datetimepicker-input"  data-target="#timepickercontainment_date" readonly>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="input-group date" data-date-format="YYYY-MM-DD" id="timepickerreport_date" data-target-input="nearest" > 
                      <input type="text" id="report_date" name="report_date" class="form-control datetimepicker-input" data-target="#timepickerreport_date" min="2022-04-27">
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            $('#issue_date').val(new Date(result0).toISOString().slice(0, 10));


            var someDate = new Date();
            var numberOfDaysToAdd = 3;
            var result = someDate.setDate(someDate.getDate() + numberOfDaysToAdd);
            $('#containment_date').val(new Date(result).toISOString().slice(0, 10));

            var someDate2 = new Date();
            var numberOfDaysToAdd2 = 14;
            var result2 = someDate2.setDate(someDate2.getDate() + numberOfDaysToAdd2);
            $('#report_date').val(new Date(result2).toISOString().slice(0, 10));

              ...
              <div class="card-body">  <!-- .card-body -->
                ...
                <table id="example1" class="table table-bordered display nowrap table-striped">
                  ...
                  <tr>
                    ...
                    <th>NIK</th>
                    <th>NAME</th>
                    <th>NIK SUPERIOR 1</th>
                    <th>NAME SUPERIOR 1</th>
                    <th>KODE SECTION SUPERIOR 1</th>
                    <th>NAME SECTION SUPERIOR 1</th>
                    <th>EMAIL SUPERIOR 1</th>
               ...
               <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                          <select class="form-control select2" id="nik_superior" name="nik_superior" onchange="handleSelectChange_nik_superior(event)" style="width: 100%;">
                            <option value='' selected="selected">-Select-</option>
                            <?php
                    ...
                    <div class="form-group">
                      <div class="row">
                          <div class="col-md-4">
                            <label for="name_superior">NAME</label>
                          </div>
                          <div class="col-md-8">
                    ...
                    <div class="form-group">
                      <div class="row">
                          <div class="col-md-4">
                            <label for="kode_setion_superior">KODE SECTION</label>
                          </div>
                          <div class="col-md-8">
                            <input type="text" name="kode_setion_superior" class="form-control" id="kode_setion_superior" >
                          </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                          ...
                          <div class="col-md-8">
                            <input type="text" name="name_section_superior" class="form-control" id="name_section_superior" >
                          </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="row">
                          ...
                          <div class="col-md-8">
                            <input type="text" name="email_superior" class="form-control" id="email_superior" >
                          </div>
                      </div>
                    </div>
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              ...
              success: function (data) {
                  ...
                  $('#kode_setion_superior').val(data.kode_setion_superior);
...
<script type="text/javascript">
  ...
  function handleSelectChange_nik_superior(event) {
  ...
  $('#kode_setion_superior').val(res[2]);

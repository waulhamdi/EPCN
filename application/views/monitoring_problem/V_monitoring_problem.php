  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Monitoring Problem Form</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <table id="example1" class="table table-bordered">
                  ...
                  <tr>
                    ...
                    <td colspan="4"> 
                      ...
                      <div class="bg-pink color-palette"> <span>Pink=Delay</span></div> 
        ...
        <div class="modal-dialog modal-lg" role="document" >
            <div class="modal-content">            
              ...
              <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <label>RANK PROBLEM (IF NEED CHANGE)</label>
                  </div>
                  <div class="col-md-8">
                    <select class="form-control select2" id="rank_problem" name="rank_problem"  style="width: 100%;">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('C_monitoring_problem/import'); ?>" enctype="multipart/form-data">
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_monitoring_problem/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_monitoring_problem/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_monitoring_problem/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_monitoring_problem/ajax_delete')?>";
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "createdRow": function( row, data, dataIndex){
              // if (data.Status_monitoring.substr(0,5) == 'Delay'){             
          ...
          <?php }  ?>
            ...
            "ajax":
            {
                "url": "<?= base_url('C_monitoring_problem/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
            ...
            "deferRender": true,
            "aLengthMenu": [[1000,10000,100000,1000000,1000000000],[1000,10000,100000,1000000,"All"]], // Combobox Limit
            "columns": [
               {"data": 'hdrid',"sortable": false, //1
                    render: function (data, type, row, meta) {
                        ...
                        <?php if ($this->session->userdata('rolename')=="Administrator Quality"){  ?>
                          mnu= mnu + '<div class="btn btn-primary btn-sm konfirmasiEdit  mr-2" data-id="'+ data +'" data-toggle="modal" data-target="#modal-default"> <i class="fa fa-edit"></i> Add Comment</div>'; 
                        <?php }  ?>
                       

                        // if ($this->session->userdata('rolename')=="BOD"){
                        //   mnu= mnu '<div class="btn btn-primary btn-sm konfirmasiEdit  mr-2" data-id="'+ data +'" data-toggle="modal" data-target="#modal-default"> <i class="fa fa-edit"></i> Add Comment</div>'; 
                        // }
                      
                        mnu = mnu + '<a class="btn btn-success btn-sm mr-2"  href="<?php echo base_url('C_Print_approved/print_report2_approved?var1=') . "'+ data +'" ?>"  target="_blank"><i class="fa fa-eye"></i> View</a>'

            ...
            <div class="modal-content">            
              ...
              <form role="form" id="quickForm">
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="reminder_procurement">REMINDER APPROVAL</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="reminder_procurement" class="form-control" id="reminder_procurement" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="reminder_qa" class="form-control" id="reminder_qa" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="reminder_application_response">REMINDER APPLICATION RESPONSE</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="reminder_application_response" class="form-control" id="reminder_application_response" >
                      </div>
                  </div>
                </div>
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        ...
        reminder_procurement: {
        required: "Please Input reminder_procurement",
        minlength: 3
        },
        reminder_qa: {
        required: "Please Input reminder_qa",
        minlength: 3
        },
        reminder_application_response: {
        required: "Please Input reminder_application_response",
        minlength: 3
        },
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              ...
              success: function (data) {
                  ...
                  $('#reminder_procurement').val(data.reminder_procurement);
                  $('#reminder_qa').val(data.reminder_qa);
                  $('#reminder_application_response').val(data.reminder_application_response);

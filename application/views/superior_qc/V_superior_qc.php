  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Superior Procurement QC</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">  <!-- .card-body -->
                ...
                <table id="example1" class="table table-bordered display nowrap table-striped">
                  ...
                  <tr>
                    ...
                    <th>NIK SUPERIOR QC</th>
                    <th>NAME SUPERIOR QC</th>
                    <th>KODE SECTION SUPERIOR QC</th>
                    <th>NAME SECTION SUPERIOR QC</th>
                    <th>EMAIL SUPERIOR QC</th>
                    <th>PRODUCT</th>
                    <th>POSITION</th>
            ...
            <div class="modal-content">            
              ...
              <form role="form" id="quickForm">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-4">
                      <label>NIK SUPERIOR QC</label>
                    </div>
                    <div class="col-md-8">
                      <select class="form-control select2" id="nik_superiorqc" name="nik_superiorqc" onchange="handleSelectChange_nik_superiorqc(event)" style="width: 100%;">
                        <option value='' selected="selected">-Select-</option>
                        <?php
                          foreach ($nik_superior_qc as $value) {
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="name_superiorqc">NAME SUPERIOR QC</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="name_superiorqc" class="form-control" id="name_superiorqc" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="kode_section_superiorqc">KODE SECTION SUPERIOR QC</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="kode_section_superiorqc" class="form-control" id="kode_section_superiorqc" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="name_section_superiorqc">NAME SECTION SUPERIOR QC</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="name_section_superiorqc" class="form-control" id="name_section_superiorqc" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="email_superiorqc">EMAIL SUPERIOR QC</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="email_superiorqc" class="form-control" id="email_superiorqc" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('C_superior_qc/import'); ?>" enctype="multipart/form-data">
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      rules: {
        ...
        kode_section_superiorqc: {
        required: true,
        },
        name_section_superiorqc: {
        required: true,
        },
        email_superiorqc: {
        required: true,
      ...
      messages: {
        ...
        nik_superiorqc: {
        required: "Please Input nik_superiorqc",
        minlength: 3
        },
        name_superiorqc: {
        required: "Please Input name_superiorqc",
        minlength: 3
        },
        kode_section_superiorqc: {
        required: "Please Input kode_section_superiorqc",
        minlength: 3
        },
        name_section_superiorqc: {
        required: "Please Input name_section_superiorqc",
        minlength: 3
        },
        email_superiorqc: {
        required: "Please Input email_superiorqc",
        minlength: 3
        },
        product: {
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_superior_qc/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
              success: function (data) {
                    ...
                    $('#nik_superiorqc').select2().val(data.nik_superiorqc).trigger('change');
                    $('#name_superiorqc').val(data.name_superiorqc);
                    $('#kode_section_superiorqc').val(data.kode_section_superiorqc);
                    $('#name_section_superiorqc').val(data.name_section_superiorqc);
                    $('#email_superiorqc').val(data.email_superiorqc);
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_superior_qc/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_superior_qc/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_superior_qc/ajax_delete')?>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_superior_qc/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
            ...
            "columns": [
               {"data": 'hdrid',"sortable": false, //1
                ...
                {"data":"hdrid"},
                {"data":"nik_superiorqc"},
                {"data":"name_superiorqc"},
                {"data":"kode_section_superiorqc"},
                {"data":"name_section_superiorqc"},
                {"data":"email_superiorqc"},
                {"data":"product"},
                {"data":"position"},
...
<script type="text/javascript">
  ...
  function handleSelectChange_nik_superiorqc(event) {
 
  //  By Text
  var value = $("#nik_superiorqc option:selected").text();  
  var res = value.split("-");
  // $('#acc_number').val(res[0]);
  $('#name_superiorqc').val(res[1]);
  $('#kode_section_superiorqc').val(res[2]);
  $('#name_section_superiorqc').val(res[3]);
  $('#email_superiorqc').val(res[4]);


  }

  function handleSelectChange_nik_superiorqc2(event) {
 
  //  By Text
  var value = $("#nik_superiorqc2 option:selected").text();  
  var res = value.split("-");
  // $('#acc_number').val(res[0]);
  $('#name_superiorqc2').val(res[1]);
  $('#kode_section_superiorqc2').val(res[2]);
  $('#name_section_superiorqc2').val(res[3]);
  $('#email_superiorqc2').val(res[4]);


  }

  function handleSelectChange_nik_superiorqc3(event) {
 
  //  By Text
  var value = $("#nik_superiorqc3 option:selected").text();  
  var res = value.split("-");
  // $('#acc_number').val(res[0]);
  $('#name_superiorqc3').val(res[1]);
  $('#kode_section_superiorqc3').val(res[2]);
  $('#name_section_superiorqc3').val(res[3]);
  $('#email_superiorqc3').val(res[4]);

                ...
                <div class="card-body">
                    ...
                    <div class="hidePrint">
                     <?php  if ($nik->name=='not found') {
                                ...
                                echo 'Need Approve By    <b>' . $nik->name. '</b> ' . $nik->position_name . ' <b>(' . $nik->position_code . ' of 12)</b>';
                            }?> 
                    ...
                    if($tb_application->status =='Closed' || $tb_application->status =='Closed Response'){
                        ...
                        <button class="mr-1 btn btn-info float-right" data-toggle="modal" data-target="#modal-answersheet" onclick="view_modal('<?php echo $tb_PCN->hdrid ?>','')">AnswerSheet <i class="fa fa-comments"></i></button> <!--lambang print-->
                    </div>
                    <!-- <php
                    ...
                    <div class="timeline">
                            ...
                            <button class="collapse-toggle">PCN Registration</button>
                                <div class="collapse-content">
                                    <!-- <php foreach ($written_proc as $proc){
                                        if(!$proc->name=='not found') {
                                            echo "PIC : " . $proc->name;
                                            echo "Date Approve/Reject : " . $proc->date_approve;
                                            echo "Status : " . $proc->stat;
                                        }                           
                                    }?> -->
                                    <?php foreach ($checked_proc as $proc){
                                        //  if(!$proc->name=='not found') {
                                            echo "PIC : " . $proc->name . "</br>";
                                            echo "Date Approve/Reject : " . $proc->date_approve . "</br>";
                                            echo "Status : " . $proc->stat . "</br>";
                                        // }; 
                                    }?>
                        ...
                        <?php if ($tb_approval[0]->position_code=='3' && $tb_approval[0]->stat=='unapprove' || $tb_approval[0]->stat=='Rejected' ) { ?>
                            <div class="timeline-item">
                            <div class="timeline-icon"></div>
                            <div class="timeline-content">
                                <p class="timeline-content-date" id="status2"></p>                                
                                <button class="btn btn-default" >Application Response</button>                                
                                <div class="collapse-content">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="collapse-content">
                                    ...
                                    <a class="btn btn-primary" href=" http://10.73.142.69/PCN/C_application?Number=<?=$hdrid?>" target="_blank">plis klik to response</a>
                                </div>
                            </div>
                        </div>
                        <?php }?>
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="collapse-content">
                                    <?php foreach ($written_qa as $qa): ?>
                                        <p><b>PIC : </b><?=  $qa->name; ?> <br>
                                            <b>Date Approve/Reject : </b><?= $qa->date_approve; ?> <br>
                                            <b>Status : </b><?= $qa->stat; ?>
                                        </p>
                                    <?php endforeach; ?>
                                    <!-- <php foreach ($checked_qa as $cek_qa): ?>
                                        <p><b>PIC : </b><=  $qa->name; ?> <br>
                                            <b>Date Approve/Reject : </b><= $qa->date_approve; ?> <br>
                                            <b>Status : </b><= $qa->stat; ?>
                                        </p>
                                    <php endforeach; ?> -->
                                    <!-- <p><b>PIC : </b><=  $written_qa[0]->name; ?> <br>
                                            <b>Date Approve/Reject : </b><= $written_qa[0]->date_approve; ?> <br>
                                            <b>Status : </b><= $written_qa[0]->stat; ?>
                                    </p>
                                    <p><b>PIC : </b><=  $written_qa[1]->name; ?> <br>
                                        <b>Date Approve/Reject : </b><= $written_qa[1]->date_approve; ?> <br>
                                        <b>Status : </b><= $written_qa[1]->stat; ?>
                                    </p>
                                    <p><b>PIC : </b><=  $written_qa[2]->name; ?> <br>
                                        <b>Date Approve/Reject : </b><= $written_qa[2]->date_approve; ?> <br>
                                        <b>Status : </b><= $written_qa[2]->stat; ?>
                                    </p> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    <p class="timeline-content-date" id="status3"></p>
                                    <button class="btn btn-default">Plan Approval</button>
                                    <div class="collapse-content">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="timeline-item">
                                <div class="timeline-icon"></div>
                                    <div class="timeline-content">
                                        ...
                                        <button class="btn btn-default">ISIR</button>
                                    </div>
                            </div>  
                        <?php }else { ?>
                            <div class="timeline-item">
                            ...
                            <div class="collapse-content">
                                <p>STATUS :</p>
                                <a class="btn btn-primary" href=" http://10.73.142.69/PCN/C_ISIR_LIST?Number=<?=$hdrid?>" target="_blank">plis klik to ISIR List</a> <br>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="collapse-content">
                                <p>Content of status 4 goes here.</p>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="timeline-icon"></div>
                            <div class="timeline-content">
                                ...
                                <div class="collapse-content">
                                    ...
                                    <?php endforeach; ?>
                                    <!-- <p><b>PIC : </b><=  $list_final[0]->name; ?> <br>
                                            <b>Date Approve/Reject : </b><= $list_final[0]->date_approve; ?> <br>
                                            <b>Status : </b><= $list_final[0]->stat; ?>
                                    </p>
                                    <p><b>PIC : </b><=  $list_final[1]->name; ?> <br>
                                        <b>Date Approve/Reject : </b><= $list_final[1]->date_approve; ?> <br>
                                        <b>Status : </b><= $list_final[1]->stat; ?>
                                    </p> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- ECR -->
                        <input id="text" type="text" hidden value="<?php $current = current_url() . '?var1=' . $tb_PCN->hdrid; print_r($current); ?>" />                                                    
                        ...
                        <div class="" style="margin-top:-1vh">
                            ...
                            <h6 style="text-align:right;"> 
                                ...
                                <!-- <php $date = $tb_PCN->transaction_date;
                        ...
                        <table id="ecrtabel" class="table table-bordered table-hover">
                            ...
                            <tr> 
                                <!-- <php
                                    $trial = $tb_PCN->trial_manufacturing;
                                    $finish = $tb_PCN->trial_manufacturing_completed_finish;
                                    $color = "red";
                                    $value = "";
                                    $month_trial = date('F',strtotime($trial));
                                    $month_finish = date('F',strtotime($trial));
                                    // var_dump($month_finish);
                                    // if ($month_trial == "December"){
                                    //     $color="red";
                                    //     $value="December";
                                    // }else{
                                    //     $color="";
                                ...
                                <td colspan="10" style="width:70%"> 
                                    <div class="row" style=" ;margin-top:1vh">
                                        <h6> &nbsp;
                                            ...
                                            $newDate = date("d - F - Y ", strtotime($date)); echo $newDate; ?>
                                        </h6>
                                        <h6><b>&nbsp; &#10230; &nbsp;</b></h6>
                                        <h6>
                                            <?php $date= $tb_PCN->trial_manufacturing_completed_finish;
                                            $newDate2 = date("d - F - Y ", strtotime($date)); echo $newDate2; ?>
                                        </h6>
                                    </div>
                                </td>
                                <!-- <td style="width:3px">
                                    <div style="height:100px; width: 100px; background-color:
                                    <php if ($month_trial== "January"){
                                            echo $color;
                                        }
                                        // if($month_finish=="January"){
                                        //     echo $color;
                                        // }
                                    ?>">
                                    </div>
                                ...
                                <td style="width:3px">
                                    <div style="height:100px; width: 100px; background-color:
                                        <php if ($month_trial== "February"){
                                            echo $color;
                                        }
                                        // elseif($month_finish=="February"){
                                        //     echo $color;
                                        // }
                                    ?>">
                                    </div>
                                ...
                                <td style="width:3px">
                                    <div style="height:100px; width: 100px; background-color:
                                        <php if ($month_trial== "March"){
                                            echo $color;
                                        }
                                        // elseif($month_finish=="March"){
                                        //     echo $color;
                                        // }
                                    ?>">
                                    </div>
                            ...
                            <tr>
                                <!-- <php
                                        $trial = $tb_PCN->process_capability_study;
                                        $finish = $tb_PCN->process_capability_study_completed_finish;    
                                        $color = "red";
                                        $value = "";
                                        $month_process = date('F',strtotime($trial));
                                ?> -->
                                <td colspan="4" style="width:20%">
                                ...
                                <td colspan="5">
                                    <div class="form-group text-left form-check">
                                        <input type="checkbox" name="NC-Major" class="form-check-input mr-3" id="NC-Major" <?php if ($tb_PCN->process_audit== 'Will Implement') {
                                            echo 'checked';} ?>> <div class="row" style="margin-left:0.1vh">
                                ...
                                <td colspan="5">
                                    <div class="form-group text-left form-check">
                                        <input type="checkbox" name="NC-Major" class="form-check-input mr-3" id="NC-Major" <?php if ($tb_PCN->process_audit== 'Will Not Implement') {
                                            echo 'checked';} ?>><p>Will not Implement</p>
                                    </div>   
                                </td>
                            </tr>    

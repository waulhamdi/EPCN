  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Superior Procurement Form</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">  <!-- .card-body -->
                ...
                <table id="example1" class="table table-bordered display nowrap table-striped">
                  ...
                  <tr>
                    ...
                    <th>NIK SUPERIOR PROCUREMENT</th>
                    <th>NAME SUPERIOR PROCUREMENT</th>
                    <th>KODE SECTION SUPERIOR PROCUREMENT</th>
                    <th>NAME SECTION SUPERIOR PROCUREMENT</th>
                    <th>EMAIL SUPERIOR PROCUREMENT</th>
                    <th>SUPPLIER</th>
                    <th>POSITION</th>
            ...
            <div class="modal-content">            
              ...
              <form role="form" id="quickForm">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-4">
                      <label>NIK SUPERIOR PROCUREMENT</label>
                    </div>
                    <div class="col-md-8">
                      <select class="form-control select2" id="nik_superiorprocurement" name="nik_superiorprocurement" onchange="handleSelectChange_nik_superiorprocurement(event)" style="width: 100%;">
                        <option value='DM111111' selected="selected">-Select-</option>
                        <?php
                          foreach ($nik_superior_proc as $value) {
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="name_superiorprocurement">NAME SUPERIOR PROCUREMENT</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="name_superiorprocurement" class="form-control" id="name_superiorprocurement" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="kode_section_superiorprocurement">KODE SECTION SUPERIOR PROCUREMENT</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="kode_section_superiorprocurement" class="form-control" id="kode_section_superiorprocurement" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4"> 
                        <label for="name_section_superiorprocurement">NAME SECTION SUPERIOR PROCUREMENT</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="name_section_superiorprocurement" class="form-control" id="name_section_superiorprocurement" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="email_superiorprocurement">EMAIL SUPERIOR PROCUREMENT</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="email_superiorprocurement" class="form-control" id="email_superiorprocurement" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('c_superior_proc/import'); ?>" enctype="multipart/form-data">
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      rules: {
        ...
        // nik_superiorprocurement: {
        // required: true,
        // },
        name_superiorprocurement: {
        required: true,
        },
        kode_section_superiorprocurement: {
        required: true,
        },
        name_section_superiorprocurement: {
        required: true,
        },
        email_superiorprocurement: {
        required: true,
        },
        supplier: {
        required: true,
      ...
      messages: {
        ...
        nik_superiorprocurement: {
        required: "Please Input nik_superiorprocurement",
        minlength: 3
        },
        name_superiorprocurement: {
        required: "Please Input name_superiorprocurement",
        minlength: 3
        },
        kode_section_superiorprocurement: {
        required: "Please Input kode_section_superiorprocurement",
        minlength: 3
        },
        name_section_superiorprocurement: {
        required: "Please Input name_section_superiorprocurement",
        minlength: 3
        },
        email_superiorprocurement: {
        required: "Please Input email_superiorprocurement",
        minlength: 3
        },
        supplier: {
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_superior_proc/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
              success: function (data) {
                  ...
                  $('#nik_superiorprocurement').select2().val(data.nik_superiorprocurement).trigger('change');
                  $('#name_superiorprocurement').val(data.name_superiorprocurement);
                  $('#kode_section_superiorprocurement').val(data.kode_section_superiorprocurement);
                  $('#name_section_superiorprocurement').val(data.name_section_superiorprocurement);
                  $('#email_superiorprocurement').val(data.email_superiorprocurement);
                  $('#supplier').val(data.supplier);
                  $('#position').select2().val(data.position).trigger('change');
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_superior_proc/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_superior_proc/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_superior_proc/ajax_delete')?>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_superior_proc/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
            ...
            "columns": [
               {"data": 'hdrid',"sortable": false, //1
                ...
                {"data":"hdrid"},
                {"data":"nik_superiorprocurement"},
                {"data":"name_superiorprocurement"},
                {"data":"kode_section_superiorprocurement"},
                {"data":"name_section_superiorprocurement"},
                {"data":"email_superiorprocurement"},
                {"data":"supplier"},
                {"data":"position"},
...
<script type="text/javascript">
  ...
  function handleSelectChange_nik_superiorprocurement(event) {
 
  //  By Text
  var value = $("#nik_superiorprocurement option:selected").text();  
  var res = value.split("-");
  // $('#acc_number').val(res[0]);
  $('#name_superiorprocurement').val(res[1]);
  $('#kode_section_superiorprocurement').val(res[2]);
  $('#name_section_superiorprocurement').val(res[3]);
  $('#email_superiorprocurement').val(res[4]);

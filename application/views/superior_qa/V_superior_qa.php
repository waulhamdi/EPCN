  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Superior QA</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">  <!-- .card-body -->
                ...
                <table id="example1" class="table table-bordered display nowrap table-striped">
                  ...
                  <tr>
                    ...
                    <th>NIK SUPERIOR QA</th>
                    <th>NAME SUPERIOR QA</th>
                    <th>KODE SECTION SUPERIOR QA</th>
                    <th>NAME SECTION SUPERIOR QA</th>
                    <th>EMAIL SUPERIOR QA</th>
                    <th>PRODUCT</th>
                    <th>POSITION</th>
            ...
            <div class="modal-content">            
              ...
              <form role="form" id="quickForm">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-4">
                      <label>NIK SUPERIOR QA</label>
                    </div>
                    <div class="col-md-8">
                      <select class="form-control select2" id="nik_superiorqa" name="nik_superiorqa" onchange="handleSelectChange_nik_superiorqa(event)" style="width: 100%;">
                        <option value='' selected="selected">-Select-</option>
                        <?php
                          foreach ($nik_superior_qa as $value) {
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="name_superiorqa">NAME SUPERIOR QA</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="name_superiorqa" class="form-control" id="name_superiorqa" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="kode_section_superiorqa">KODE SECTION SUPERIOR QA</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="kode_section_superiorqa" class="form-control" id="kode_section_superiorqa" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="name_section_superiorqa">NAME SECTION SUPERIOR QA</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="name_section_superiorqa" class="form-control" id="name_section_superiorqa" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="email_superiorqa">EMAIL SUPERIOR QA</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="email_superiorqa" class="form-control" id="email_superiorqa" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('C_superior_qa/import'); ?>" enctype="multipart/form-data">
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      rules: {
        ...
        kode_section_superiorqa: {
        required: true,
        },
        name_section_superiorqa: {
        required: true,
        },
        email_superiorqa: {
        required: true,
        ...
        nik_superiorqa: {
        required: "Please Input nik_superiorqa",
        minlength: 3
        },
        name_superiorqa: {
        required: "Please Input name_superiorqa",
        minlength: 3
        },
        kode_section_superiorqa: {
        required: "Please Input kode_section_superiorqa",
        minlength: 3
        },
        name_section_superiorqa: {
        required: "Please Input name_section_superiorqa",
        minlength: 3
        },
        email_superiorqa: {
        required: "Please Input email_superiorqa",
        minlength: 3
        },
        product: {
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_superior_qa/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
              success: function (data) {
                  ...
                  $('#nik_superiorqa').select2().val(data.nik_superiorqa).trigger('change');
                  $('#name_superiorqa').val(data.name_superiorqa);
                  $('#kode_section_superiorqa').val(data.kode_section_superiorqa);
                  $('#name_section_superiorqa').val(data.name_section_superiorqa);
                  $('#email_superiorqa').val(data.email_superiorqa);
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_superior_qa/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_superior_qa/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_superior_qa/ajax_delete')?>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_superior_qa/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
            ...
            "columns": [
               {"data": 'hdrid',"sortable": false, //1
                ...
                {"data":"hdrid"},
                {"data":"nik_superiorqa"},
                {"data":"name_superiorqa"},
                {"data":"kode_section_superiorqa"},
                {"data":"name_section_superiorqa"},
                {"data":"email_superiorqa"},
                {"data":"product"},
                {"data":"position"},
...
<script type="text/javascript">
  ...
  function handleSelectChange_nik_superiorqa(event) {
 
  //  By Text
  var value = $("#nik_superiorqa option:selected").text();  
  var res = value.split("-");
  // $('#acc_number').val(res[0]);
  $('#name_superiorqa').val(res[1]);
  $('#kode_section_superiorqa').val(res[2]);
  $('#name_section_superiorqa').val(res[3]);
  $('#email_superiorqa').val(res[4]);

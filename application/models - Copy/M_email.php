...
class M_email extends CI_Model {
   ...
   public function Send_mail_reminder($hdrid,$product_id,$subject,$position)
   {
    ...
    public function Send_mail_reminder_v1( $hdrid,$name2,$email2, $subject,$comment,$body_content)
    {
    
        $result = $this->db->query("sp_send_mail_reminder @hdrid='$hdrid',@nik='XXX',@name='$name2',@email='$email2',@EmailSubject='$subject ',@Email_body_content='$body_content',@comment='$comment'")->result_array();

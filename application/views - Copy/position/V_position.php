  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Position Form</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="modal-content">            
              ...
              <form role="form" id="quickForm">
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="position_code">TRANSACTION ID</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="position_code" class="form-control" id="position_code" placeholder="auto generate" readonly>
                      </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-8">
                        <!-- <input type="text" name="position_name" class="form-control" id="position_name" > -->
                         <textarea class="form-control" rows="3" name="position_name" id="position_name" placeholder="Enter ..."></textarea>
                      </div>
                  </div>
                </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('C_position/import'); ?>" enctype="multipart/form-data">
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        ...
        sequence: {
        required: "Please Input sequence",
        minlength: 3
        },
...
<script type="text/javascript">
  ...
  function view_modal(position_code1,status){
          ...
          if (status=="Add"){
            ...
            // Get Hdri ID
            $('#position_code').val(position_code1);
            var position_code=position_code1;   

            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_position/ajax_getbyposition_code')?>",
              method: "get",
              dataType : "JSON",              
              data: {position_code:position_code1},
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_position/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_position/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Delete by position_code
      fdata.append('position_code',$('#iddelete').text());
      // Url Post delete
      vurl = "<?php echo base_url('C_position/ajax_delete')?>";
  ...
  function Send_mail(){
    ...
    // Form data
    var fdata = new FormData();
    fdata.append('position_code','position_code123');
...
<script type="text/javascript">
    ...
    //  position_code selected konfirmasiHapus
    $(document).on("click", ".konfirmasiHapus", function() {        
        $('#iddelete').text($(this).attr("data-id")); 
    })

    //  position_code selected  konfirmasiEdit
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_position/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
            ...
            "columns": [
               {"data": 'position_code',"sortable": false, //1

                                            ...
                                            <table id="ecrtabel" class="table table-bordered table-hover">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="text-align:center; vertical-align: middle;" rowspan="2"><?= $tb_input_problem->hdrid; ?></th>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php $date1 = $tb_input_problem->issue_date;
                                            ...
                                            <table class="table table-bordered table-hover" style="text-align:center">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php 
                                                        $date2 = $tb_response->date_response_2;        
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $array_approval[0]->department_name; ?></td>
                                                        <td><?= $array_approval[0]->name; ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td colspan="4" style="text-align:center; vertical-align: middle;"><?= $tb_input_problem->detail_problem; ?></td>
                                                        <td style="text-align:center; vertical-align: middle;">5(d) 3(m) 21(y)</td>
                                                        <td><?= $array_approval[1]->department_name; ?></td>
                                                        <td><?= $array_approval[1]->name; ?></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $array_approval[2]->department_name; ?></td>
                                                        <td><?= $array_approval[2]->name; ?></td>
                                                    </tr>

                                                    <tr>
                                                        <td colspan="2" rowspan="3" style="text-align:center; vertical-align: middle;">
                                                            <?= $tb_input_problem->product_name; ?>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2" style="text-align:left;"> <?= $tb_input_problem->part_number; ?></td>
                                                        <td><?= $array_approval[3]->department_name; ?></td>
                                                        <td><?= $array_approval[3]->name; ?></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $array_approval[4]->department_name; ?></td>
                                                        <td><?= $array_approval[4]->name; ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table class="table table-bordered table-hover" style="text-align:center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="height: 50px;">
                                                        <td colspan="18"><?= $tb_response->occurrence_why_1; ?></td>
                                                        <td colspan="20"><?= $tb_response->occurrence_prevention_1; ?></td>
                                                        <td colspan="4"><?= $tb_response->occurrence_date_1; ?></td>
                                                        <td colspan="3">
                                                            NEED YOKOTENKAI ?
                                                        </td>
                                                        <td colspan="6">
                                                            <div class="form-check-inline">
                                                                <input type="checkbox" name="Y" class="form-check-input mr-3" id="Y" <?php if ($tb_response->yokotenkai == 'yokotenkai') {
                                                                                                                                            echo 'checked';
                                                                                                                                        } ?>>
                                                            ...
                                                            <div class="form-check-inline">
                                                                <input type="checkbox" name="N" class="form-check-input mr-3" id="N" <?php if ($tb_response->yokotenkai == 'yokotenkai2') {
                                                                                                                                            echo 'checked';
                                                                                                                                        } ?>>
                                                    ...
                                                    <tr>
                                                        <td colspan="18"><?= $tb_response->occurrence_why_2; ?></td>
                                                        <td colspan="20"><?= $tb_response->occurrence_prevention_2; ?></td>
                                                        <td colspan="4"><?= $tb_response->occurrence_date_2; ?></td>
                                                    ...
                                                    <tr style="height: 50px;">
                                                        <td colspan="18"><?= $tb_response->occurrence_why_3; ?></td>
                                                        <td colspan="20"><?= $tb_response->occurrence_prevention_3; ?></td>
                                                        <td colspan="4"><?= $tb_response->occurrence_date_3; ?></td>
                                                        <td colspan="3" rowspan="4"> - </td>
                                                        <td colspan="3" rowspan="4"> - </td>
                                                    </tr>

                                                    <tr style="height: 50px;">
                                                        <td colspan="18"><?= $tb_response->occurrence_why_4; ?></td>
                                                        <td colspan="20"><?= $tb_response->occurrence_prevention_4; ?></td>
                                                        <td colspan="4"><?= $tb_response->occurrence_date_4; ?></td>
                                                    </tr>

                                                    <tr style="height: 50px;">
                                                        <td colspan="18"><?= $tb_response->occurrence_why_5; ?></td>
                                                        <td colspan="20"><?= $tb_response->occurrence_prevention_5; ?></td>
                                                        <td colspan="4"><?= $tb_response->occurrence_date_5; ?></td>
                                                    </tr>
                                                    ...
                                                    <tr style="height: 50px;">
                                                        ...
                                                        <td colspan="4"></td>
                                                        <td colspan="9" style="background-color: #D9D9D9;">
                                                            ＜ Cross check to another section / YOKOTENKAI ＞
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr style="height: 50px;">
                                                        ...
                                                        <td colspan="6">
                                                            <div class="form-check-inline">
                                                                <input type="checkbox" name="Y" class="form-check-input mr-3" id="Y" <?php if ($tb_response->yokotenkai_other_section == 'yokotenkai_other_section') {
                                                                                                                                            echo 'checked';
                                                                                                                                        } ?>>
                                                                <label for="Y" class="form-check-label">
                                                                    YES
                                                            ...
                                                            <div class="form-check-inline">
                                                                <input type="checkbox" name="N" class="form-check-input mr-3" id="N" <?php if ($tb_response->yokotenkai_other_section == 'yokotenkai_other_section2') {
                                                                                                                                            echo 'checked';
                                                                                                                                        } ?>>
                                                                <label for="N" class="form-check-label">
                                                                    NO
                                                    ...
                                                    <tr style="height: 50px;">
                                                        <td colspan="18"><?= $tb_response->flow_out_why_1; ?></td>
                                                        <td colspan="20"><?= $tb_response->flow_out_prevention_1; ?></td>
                                                        <td colspan="4"><?= $tb_response->flow_out_date_1; ?></td>
                                                    ...
                                                    <tr style="height: 50px;">
                                                        <td colspan="18"><?= $tb_response->flow_out_why_2; ?></td>
                                                        <td colspan="20"><?= $tb_response->flow_out_prevention_2; ?></td>
                                                        <td colspan="4"><?= $tb_response->flow_out_date_2; ?></td>
                                                    ...
                                                    <tr style="height: 50px;">
                                                        <td colspan="18"><?= $tb_response->flow_out_why_3; ?></td>
                                                        <td colspan="20"><?= $tb_response->flow_out_prevention_3; ?></td>
                                                        <td colspan="4"><?= $tb_response->flow_out_date_3; ?></td>
                                                    ...
                                                    <tr style="height: 50px;">
                                                        <td colspan="18"><?= $tb_response->flow_out_why_4; ?></td>
                                                        <td colspan="20"><?= $tb_response->flow_out_prevention_4; ?></td>
                                                        <td colspan="4"><?= $tb_response->flow_out_date_4; ?></td>
                                                    ...
                                                    <tr style="height: 50px;">
                                                        <td colspan="18"><?= $tb_response->flow_out_why_5; ?></td>
                                                        <td colspan="20"><?= $tb_response->flow_out_prevention_5; ?></td>
                                                        <td colspan="4"><?= $tb_response->flow_out_date_5; ?></td>

  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Monthly PPM & Case Form</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">  <!-- .card-body -->
                ...
                <table id="example1" class="table table-bordered display nowrap table-striped">
                  ...
                  <tr>
                    ...
                    <!-- <th>QUANTITY PPM CASE TARGET</th> -->
                    <th>YEAR PPM CASE TARGET</th>
                    <th>MONTH PPM CASE TARGET</th>
        ...
        <div class="modal-dialog modal-lg" role="document" >
            <div class="modal-content">            
              ...
              <!-- <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="quantity_ppm_case_target">QUANTITY PPM CASE TARGET</label>
                    </div>
                    <div class="col-md-8">
                      <input type="number" name="quantity_ppm_case_target" class="form-control" id="quantity_ppm_case_target" >
                    </div>
                </div>
              </div> -->
              ...
              <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="input-group date year-only" data-date-format="YYYY"  id="timepickeryear_ppm_case_target" data-target-input="nearest">
                        <input type="text" id="year_ppm_case_target" name="year_ppm_case_target" class="form-control datetimepicker-input" data-target="#timepickeryear_ppm_case_target"/>
                          <div class="input-group-append" data-target="#timepickeryear_ppm_case_target" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                          </div>
                      </div>
                    </div>
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label>MONTH PPM CASE TARGET:</label>
                    </div>
                    <div class="col-md-4">
                      <div class="input-group date month-only" data-date-format="MM"  id="timepickermonth_ppm_case_target" data-target-input="nearest">
                        <input type="text" id="month_ppm_case_target" name="month_ppm_case_target" class="form-control datetimepicker-input" data-target="#timepickermonth_ppm_case_target"/>
                          <div class="input-group-append" data-target="#timepickermonth_ppm_case_target" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                          </div>
                      </div>
                    </div>
              ...
              <div class="row">
                  <div class="col-md-4">
                    <label for="target_monthly">TARGET MONTHLY</label>
                  </div>
                  <div class="col-md-8">
                    <input type="number" name="target_monthly" class="form-control" id="target_monthly" >
                  </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <div class="row">
                  <div class="col-md-4">
                    <label for="target_yearly">TARGET YEARLY</label>
                  </div>
                  <div class="col-md-8">
                    <input type="number" name="target_yearly" class="form-control" id="target_yearly" >
                  </div>
              </div>
            </div> -->
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="case_target">CASE TARGET AKUMULASI</label>
                    </div>
                    <div class="col-md-8">
                      <input type="number" name="case_target" class="form-control" id="case_target" >
                    </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="case_actual">CASE ACTUAL AKUMULASI</label>
                    </div>
                    <div class="col-md-8">
                      <input type="number" name="case_actual" class="form-control" id="case_actual" >
                    </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="ppm_target">PPM TARGET AKUMULASI</label>
                    </div>
                    <div class="col-md-8">
                      <input type="number" name="ppm_target" class="form-control" id="ppm_target" >
                    </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="ppm_actual">PPM ACTUAL AKUMULASI</label>
                    </div>
                    <div class="col-md-8">
                      <input type="number" name="ppm_actual" class="form-control" id="ppm_actual" >
                    </div>
                </div>
              </div>
<!-- 
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <select class="form-control select2" id="jenis" name="jenis" onchange="handleSelectChange_jenis(event)" style="width: 100%;">
                    <option value='' selected="selected">-Select-</option>
                    <php
              ...
              <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="input-group date" data-date-format="YYYY-MM-DD"  id="timepickerppm_case_date" data-target-input="nearest">
                      <input readonly placeholder="auto generate" type="text" id="ppm_case_date" name="ppm_case_date" class="form-control datetimepicker-input " data-target="#timepickerppm_case_date"/>
                        <div class="input-group-append" data-target="#timepickerppm_case_date" data-toggle="datetimepicker">
                          <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                        </div>
                    </div>
                  </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('c_ppm_case_target/import'); ?>" enctype="multipart/form-data">
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      rules: {
        ...
        year_ppm_case_target: {
        required: true,
        },
        month_ppm_case_target: {
        required: true,
        },
        case_target: {
        required: true,
      ...
      messages: {
        ...
        year_ppm_case_target: {
        required: "Please Input year_ppm_case_target",
        minlength: 3
        },
        month_ppm_case_target: {
        required: "Please Input month_ppm_case_target",
        minlength: 3
        },
        case_target: {
        required: "Please Input case_target",
        minlength: 3
        },
        case_actual: {
        required: "Please Input case_actual",
        minlength: 3
        },
        ppm_target: {
        required: "Please Input ppm_target",
        minlength: 3
        },
        ppm_actual: {
        required: "Please Input ppm_actual",
        minlength: 3
        },
        ppm_case_date: {
        required: "Please Input ppm_case_date",
        minlength: 3
        },
        group_product_id: {
        ...
        // quantity_ppm_case_target: {
        // required: "Please Input quantity_ppm_case_target",
        // minlength: 3
        // },
        // jenis: {
        // required: "Please Input jenis",
        // minlength: 3
        // },
        // target_monthly: {
        // required: "Please Input target_monthly",
        // minlength: 3
        // },
        // target_yearly: {
        // required: "Please Input target_yearly",
        // minlength: 3
        // },
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_ppm_case_target/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
              success: function (data) {
                    ...
                    $('#year_ppm_case_target').val(data.year_ppm_case_target);
                    $('#month_ppm_case_target').val(data.month_ppm_case_target);
                    $('#case_target').val(data.case_target);
                    $('#case_actual').val(data.case_actual);
                    $('#ppm_target').val(data.ppm_target);
                    $('#ppm_actual').val(data.ppm_actual);
                    // $('#target_monthly').val(data.target_monthly);
                    // $('#target_yearly').val(data.target_yearly);
                    // $('#ppm_case_date').val(data.ppm_case_date);
                    $('#group_product_id').select2().val(data.group_product_id).trigger('change');
                    $('#group_product_name').val(data.group_product_name);
                    // $('#quantity_ppm_case_target').val(data.quantity_ppm_case_target);
                    // $('#jenis').select2().val(data.jenis).trigger('change');
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_ppm_case_target/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_ppm_case_target/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_ppm_case_target/ajax_delete')?>";
...
<script type="text/javascript">
  ...
  $("#timepickeryear_ppm_case_target").datetimepicker({
      autoclose: true,
      format: " yyyy",
      viewMode: "years",
      minViewMode: "years"
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_ppm_case_target/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
            ...
            "columns": [
               {"data": 'hdrid',"sortable": false, //1
                ...
                // {"data":"quantity_ppm_case_target"},
                {"data":"year_ppm_case_target"},
                {"data":"month_ppm_case_target"},
                // {"data":"target_monthly"},
                // {"data":"target_yearly"},
                {"data":"case_target"},
                {"data":"case_actual"},

  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">PPM Case Input Form</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Dashboard PCN<</a></li>
              <li class="breadcrumb-item active">DMIA SYSTEM PCN</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">  <!-- .card-body -->
                ...
                <table id="example1" class="table table-bordered display nowrap table-striped">
                  ...
                  <tr>
                    ...
                    <th>YEAR PPM CASE INPUT</th>
                    <th>MONTH PPM CASE INPUT</th>
        ...
        <div class="modal-dialog modal-lg" role="document" >
            <div class="modal-content">            
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label>YEAR PPM CASE INPUT:</label>
                    </div>
                    <div class="col-md-4">
                      <div class="input-group date" data-date-format="YYYY"  id="timepickeryear_ppm_case_input" data-target-input="nearest">
                        <input type="text" id="year_ppm_case_input" name="year_ppm_case_input" class="form-control datetimepicker-input" data-target="#timepickeryear_ppm_case_input"/>
                          <div class="input-group-append" data-target="#timepickeryear_ppm_case_input" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                          </div>
                      </div>
                    </div>
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label>MONTH PPM CASE INPUT:</label>
                    </div>
                    <div class="col-md-4">
                      <div class="input-group date" data-date-format="MM"  id="timepickermonth_ppm_case_input" data-target-input="nearest">
                        <input type="text" id="month_ppm_case_input" name="month_ppm_case_input" class="form-control datetimepicker-input" data-target="#timepickermonth_ppm_case_input"/>
                          <div class="input-group-append" data-target="#timepickermonth_ppm_case_input" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                          </div>
                      </div>
                    </div>
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="quantity_ppm_case_input">QUANTITY PPM CASE INPUT</label>
                    </div>
                    <div class="col-md-8">
                      <input type="text" name="quantity_ppm_case_input" class="form-control" id="quantity_ppm_case_input" >
                    </div>
                </div>
              </div>
              <div class="form-group">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('c_ppm_case_input/import'); ?>" enctype="multipart/form-data">
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      ...
      year_ppm_case_input: {
      required: "Please Input year_ppm_case_input",
      minlength: 3
      },
      month_ppm_case_input: {
      required: "Please Input month_ppm_case_input",
      minlength: 3
      },
      group_product_id: {
      ...
      quantity_ppm_case_input: {
      required: "Please Input quantity_ppm_case_input",
      minlength: 3
      },
      jenis: {
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_ppm_case_input/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
              success: function (data) {
                    ...
                    $('#year_ppm_case_input').val(data.year_ppm_case_input);
                    $('#month_ppm_case_input').val(data.month_ppm_case_input);
                    $('#group_product_id').select2().val(data.group_product_id).trigger('change');
                    $('#group_product_name').val(data.group_product_name);
                    $('#quantity_ppm_case_input').val(data.quantity_ppm_case_input);
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_ppm_case_input/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_ppm_case_input/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_ppm_case_input/ajax_delete')?>";
...
$("#timepickeryear_ppm_case_input").datetimepicker({
      autoclose: true,
      format: " yyyy",
      viewMode: "years",
      minViewMode: "years"
  ...
  $("#timepickermonth_ppm_case_input").datetimepicker({
      autoclose: true,
      format: " MM",
      viewMode: "months",
      minViewMode: "months"
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_ppm_case_input/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
            ...
            "columns": [
               {"data": 'hdrid',"sortable": false, //1
                ...
                {"data":"hdrid"},
                {"data":"year_ppm_case_input"},
                {"data":"month_ppm_case_input"},
                {"data":"group_product_id"},
                {"data":"group_product_name"},
                {"data":"quantity_ppm_case_input"},
                {"data":"jenis"},

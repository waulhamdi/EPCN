...
class M_progress extends CI_Model
{
    ...
    function get_tables_where2($tables, $cari, $where, $iswhere,$nikSession)
    {
        ...
        if (!empty($iswhere)) {
            $sql = $this->db->query("SELECT DISTINCT a.hdrid, a.group_product_id,a.due_date, a.group_product_name, a.customer_id, a.customer_name, a.problem_name, a.status_transaction FROM " . $tables . " a JOIN tb_approval b ON a.hdrid = b.problem_id  WHERE $iswhere AND " . $fwhere." OR a.nik='$nikSession'");
        } else {
            $sql = $this->db->query("SELECT DISTINCT a.hdrid, a.group_product_id,a.due_date, a.group_product_name, a.customer_id, a.customer_name, a.problem_name, a.status_transaction FROM " . $tables . " a JOIN tb_approval b ON a.hdrid = b.problem_id  WHERE " . $fwhere." OR a.nik='$nikSession'");
        }
        $sql_count = $sql->num_rows();
        ...
        if (!empty($iswhere)) {
            $sql_data = $this->db->query("SELECT DISTINCT a.hdrid, a.group_product_id,a.due_date, a.group_product_name, a.customer_id, a.customer_name, a.problem_name, a.status_transaction FROM " . $query . " a JOIN tb_approval b ON a.hdrid = b.problem_id  WHERE $iswhere AND " . $fwhere."OR a.nik='$nikSession'" . " AND (" . $cari . ")" . $order . " OFFSET " . $start . " ROWS FETCH NEXT " . $limit . " ROWS only ");
        } else {
            $sql_data = $this->db->query("SELECT DISTINCT a.hdrid, a.group_product_id,a.due_date, a.group_product_name, a.customer_id, a.customer_name, a.problem_name, a.status_transaction FROM " . $query . " a JOIN tb_approval b ON a.hdrid = b.problem_id  WHERE " . $fwhere."OR a.nik='$nikSession'" . " AND (" . $cari . ")" . $order . " OFFSET " . $start . " ROWS FETCH NEXT " . $limit . " ROWS only ");
        }

        if (isset($search)) {
            if (!empty($iswhere)) {
                $sql_cari =  $this->db->query("SELECT DISTINCT a.hdrid, a.group_product_id,a.due_date, a.group_product_name, a.customer_id, a.customer_name, a.problem_name, a.status_transaction FROM " . $query . " a JOIN tb_approval b ON a.hdrid = b.problem_id  WHERE $iswhere AND " . $fwhere."OR a.nik='$nikSession'" . " AND (" . $cari . ")");
            } else {
                $sql_cari =  $this->db->query("SELECT DISTINCT a.hdrid, a.group_product_id,a.due_date, a.group_product_name, a.customer_id, a.customer_name, a.problem_name, a.status_transaction FROM " . $query . " a JOIN tb_approval b ON a.hdrid = b.problem_id  WHERE " . $fwhere."OR a.nik='$nikSession'" . " AND (" . $cari . ")");
            }
            $sql_filter_count = $sql_cari->num_rows();
        } else {
            if (!empty($iswhere)) {
                $sql_filter = $this->db->query("SELECT DISTINCT a.hdrid, a.group_product_id,a.due_date, a.group_product_name, a.customer_id, a.customer_name, a.problem_name, a.status_transaction FROM " . $tables . " a JOIN tb_approval b ON a.hdrid = b.problem_id  WHERE $iswhere AND " . $fwhere."OR a.nik='$nikSession'");
            } else {
                $sql_filter = $this->db->query("SELECT DISTINCT a.hdrid, a.group_product_id,a.due_date, a.group_product_name, a.customer_id, a.customer_name, a.problem_name, a.status_transaction FROM " . $tables . " a JOIN tb_approval b ON a.hdrid = b.problem_id  WHERE " . $fwhere."OR a.nik='$nikSession'");
            }
            $sql_filter_count = $sql_filter->num_rows();
        }
   ...
   function Update_Data_Respone_ver2($hdrid,$datetime){

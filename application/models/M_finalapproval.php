...
class M_finalapproval extends CI_Model {
...
//    public function tampil_supplier_name_and_code()
//    {
//        $query =  $this->db->get('tb_input_problem')->result(); //contoh dari tabel input problem nanti ganti table kalau sudah fiks
//        return $query;
//    }

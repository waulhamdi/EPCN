...
class C_PrintA4_isir extends CI_Controller
{
    ...
    function print_show()
    {
        ...
        $test = $data['tb_input_problem'] = $this->m_printA4_isir->ajax_getbyhdrid($hdrid, 'tb_input_problem')->row();//ajax data ambil data dari tabel
        // error_reporting(0);
    ...
    function print_report1()
    {
        ...
        $data['tb_input_problem'] = $this->m_printA4_isir->ajax_getbyhdrid($hdrid, 'tb_input_problem')->row();//print hasil dari tb_input_problem
        $data['tb_response'] = $this->m_printA4_isir->ajax_getbyhdrid($hdrid, 'tb_response')->row();//print hasil dari tb_response
        $data['tb_approval'] = $this->m_printA4_isir->ajax_getbyproblemid($app, 'tb_approval')->row();//print hasil dari tb_approval
        $data['tb_effectiveness'] = $this->m_printA4_isir->ajax_getbyhdrid($hdrid, 'tb_input_effectiveness')->row();//print hasil dari tb_input_effectiveness
    ...
    function print_report2()
    {
        ...
        // $data['tb_pc'] = $this->m_printA4_isir->ajax_getbyhdrid($hdrid,'tb_response')->row();
        // // $data['tb_pe'] = $this->m_printA4_isir->ajax_getbyhdrid($hdrid,'tb_approval')->row();
        // $data['tb_qa'] = $this->m_printA4_isir->ajax_getbyhdrid($hdrid,'tb_input_effectiveness')->row();
    ...
    function print_report2_approved()
    {
        ...
        $data['tb_approval'] = $this->m_printA4_isir->ajax_getbyproblem_id($problem_id, 'tb_approval')->result();
        $data['tb_application'] = $this->m_printA4_isir->ajax_getbypcn_number($hdrid, 'tb_application')->row();
        // var_dump($data['tb_application']);

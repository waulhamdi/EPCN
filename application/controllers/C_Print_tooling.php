...
class C_Print_tooling extends CI_Controller
{
        ///@see __construct()
    ...
    public function __construct()
    {
        ...
        $this->load->model('m_print_tooling'); //connect ke m_print_tooling
    ...
    function ajax_getbyhdrid()
    {
        ...
        $data = $this->m_print_tooling->ajax_getbyhdrid($hdrid, 'tb_input_problem')->row();//ajax data ambil data dari tabel
    ...
    function print_show()
    {
        ...
        $test = $data['tb_input_problem'] = $this->m_print_tooling->ajax_getbyhdrid($hdrid, 'tb_input_problem')->row();//ajax data ambil data dari tabel
        // error_reporting(0);
    ...
    function print_report1()
    {
        ...
        $data['tb_input_problem'] = $this->m_print_tooling->ajax_getbyhdrid($hdrid, 'tb_input_problem')->row();//print hasil dari tb_input_problem
        $data['tb_response'] = $this->m_print_tooling->ajax_getbyhdrid($hdrid, 'tb_response')->row();//print hasil dari tb_response
        $data['tb_approval'] = $this->m_print_tooling->ajax_getbyproblemid($app, 'tb_approval')->row();//print hasil dari tb_approval
        $data['tb_effectiveness'] = $this->m_print_tooling->ajax_getbyhdrid($hdrid, 'tb_input_effectiveness')->row();//print hasil dari tb_input_effectiveness
        $data['array_approval'] = $this->m_print_tooling->getApproval($hdrid);       //print hasil dari array_approval
    ...
    function print_report2()
    {
        ...
        // $data['tb_pc'] = $this->m_print_tooling->ajax_getbyhdrid($hdrid,'tb_response')->row();
        // // $data['tb_pe'] = $this->m_print_tooling->ajax_getbyhdrid($hdrid,'tb_approval')->row();
        // $data['tb_qa'] = $this->m_print_tooling->ajax_getbyhdrid($hdrid,'tb_input_effectiveness')->row();
    ...
    function print_tooling()
    {
        ...
        $data['tb_tooling2'] = $this->m_print_tooling->ajax_getbyhdrid($hdrid, 'tb_tooling2')->row();
        $data['list_tooling'] = $this->m_print_tooling->gettooling($hdrid);
        // $data['tb_response'] = $this->m_print_tooling->ajax_getbyhdrid($hdrid, 'tb_response')->row();//print hasil dari tb_response
        // $data['tb_approval'] = $this->m_print_tooling->ajax_getbyproblemid($app, 'tb_approval')->row();//print hasil dari tb_approval

        // $data['tb_approval_name'] = $this->m_print_tooling->getname_aprover($hdrid);//print hasil dari tb_approval_name
       
        // $data['tb_effectiveness'] = $this->m_print_tooling->ajax_getbyhdrid($hdrid, 'tb_input_effectiveness')->row();//print hasil dari tb_effectiveness
        // $data['array_approval'] = $this->m_print_tooling->getApproval($hdrid);//print hasil dari array_approval
        // $data['nik'] = $this->m_print_tooling->cari_tb_approver($hdrid);//print hasil dari nik
        ...
        $this->load->view('Print/v_print_tooling', $data);//hasil print di view

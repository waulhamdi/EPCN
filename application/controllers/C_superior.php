...
class C_superior extends CI_Controller {
	...
	public function Index()
	{
     ...
     function view_data()
     {
        ...
        $tables = "tb_superior";         
        $search = array('hdrid','nik','name','nik_superior','name_superior','kode_setion_superior','name_section_superior','email_superior','name_superior2','kode_setion_superior2','name_section_superior2','email_superior2');
				...
				foreach ($sheetData as $key => $value) {
                       ...
                       if($rowexcel>2){
                        ...
                        // ---------------------------------- Import Macro Batas sini 1---------------------------------
                            ...
                            $resultData[$index]['nik_superior'] = ucwords($value['C']);
                            $resultData[$index]['name_superior'] = ucwords($value['D']);
                            $resultData[$index]['kode_setion_superior'] = ucwords($value['E']);
                            $resultData[$index]['name_section_superior'] = ucwords($value['F']);
                            $resultData[$index]['email_superior'] = ucwords($value['G']);
                            
                            $resultData[$index]['nik_superior2'] = ucwords($value['H']);
                            $resultData[$index]['name_superior2'] = ucwords($value['I']);
                            $resultData[$index]['kode_setion_superior2'] = ucwords($value['J']);
                            $resultData[$index]['name_section_superior2'] = ucwords($value['K']);
                            $resultData[$index]['email_superior2'] = ucwords($value['L']);

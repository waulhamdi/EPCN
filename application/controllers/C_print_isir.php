...
class C_print_isir extends CI_Controller
{
     ///@see __construct()
    ...
    public function __construct()
    {
        ...
        $this->load->model('m_print_isir');//connect ke m_print_isir
    ...
    public function index()
    {
        ...
        $this->load->view('Print/v_print_isir', $data);
    }

     ///@see ajax_getbyhdrid1()
     ///@note fungsi untuk code hdrid ditarik ke web
     ///@attention
    function ajax_getbyhdrid11()
    {

        $hdrid = $this->input->get('hdrid');//data dari hdrid
        $data = $this->m_print_isir->ajax_getbyhdrid11($hdrid, 'tb_input_problem')->row();//ajax data ambil data dari tabel
    ...
    function print_show()
    {
        ...
        $test = $data['tb_input_problem'] = $this->m_print_isir->ajax_getbyhdrid11($hdrid, 'tb_input_problem')->row();//ajax data ambil data dari tabel
        // error_reporting(0);
    ...
    function print_report1()
    {
        ...
        $data['tb_input_problem'] = $this->m_print_isir->ajax_getbyhdrid1($hdrid, 'tb_input_problem')->row();//print hasil dari tb_input_problem
        $data['tb_response'] = $this->m_print_isir->ajax_getbyhdrid1($hdrid, 'tb_response')->row();//print hasil dari tb_response
        $data['tb_approval'] = $this->m_print_isir->ajax_getbyproblemid($app, 'tb_approval')->row();//print hasil dari tb_approval
        $data['tb_effectiveness'] = $this->m_print_isir->ajax_getbyhdrid1($hdrid, 'tb_input_effectiveness')->row();//print hasil dari tb_input_effectiveness
        $data['array_approval'] = $this->m_print_isir->getApproval($hdrid);       //print hasil dari array_approval
    ...
    ///@see print_report2()
     ...
     function print_report2()
     {
         ...
         // $data['tb_pc'] = $this->m_print_isir->ajax_getbyhdrid1($hdrid,'tb_response')->row();
         // // $data['tb_pe'] = $this->m_print_isir->ajax_getbyhdrid1($hdrid,'tb_approval')->row();
         // $data['tb_qa'] = $this->m_print_isir->ajax_getbyhdrid1($hdrid,'tb_input_effectiveness')->row();
    ...
    function print_isir()
    {
        ...
        $data['tb_ISIR_information'] = $this->m_print_isir->ajax_getbyhdrid1($hdrid, 'tb_ISIR_information')->row();
        $data['tb_response'] = $this->m_print_isir->ajax_getbyhdrid1($hdrid, 'tb_response')->row();//print hasil dari tb_response
        $data['tb_approval'] = $this->m_print_isir->ajax_getbyproblemid($app, 'tb_approval')->row();//print hasil dari tb_approval

        $data['tb_approval_name'] = $this->m_print_isir->getname_aprover($hdrid);//print hasil dari tb_approval_name
       
        $data['tb_effectiveness'] = $this->m_print_isir->ajax_getbyhdrid1($hdrid, 'tb_input_effectiveness')->row();//print hasil dari tb_effectiveness
        $data['array_approval'] = $this->m_print_isir->getApproval($hdrid);//print hasil dari array_approval
        $data['nik'] = $this->m_print_isir->cari_tb_approver($hdrid);//print hasil dari nik
        ...
        $this->load->view('Print/v_print_isir', $data);//hasil print di view

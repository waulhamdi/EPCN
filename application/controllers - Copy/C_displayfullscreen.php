...
class C_displayfullscreen extends CI_Controller {
    ...
    **/
	...
	public function Index()
	{
        ...
        if($this->session->userdata('authenticated')){ // Jika user sudah login (Session authenticated ditemukan)
            ...
            $FiscalYear = $this->M_display->Fiscal_Year(); // Ambil data nama user from ESS
            ...
            $data['fiscalyear']=$this->M_display->Fiscal_Year();
            
            $this->load->view('display/V_displayfullscreen',$data); // Tampil data //,$data

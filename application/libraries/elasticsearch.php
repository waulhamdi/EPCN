...
class ElasticSearch
{
    ...
    */
    ...
    /**
     * set the mapping for the index <=== Note: tidak jalan ===>
     * 
     * @param string $type
     * @param json   $data
     * 
    ...
    /**
     * set the mapping for the index (ok)
     * 
     * @param type $type
     * @param type $id
     * @param type $data php array
     * 
     * @return type
     */
    ...
    /**
     * make a advanced search query with json data to send (ok)
     * 
     * @param type $type
     * @param type $query
     * 
